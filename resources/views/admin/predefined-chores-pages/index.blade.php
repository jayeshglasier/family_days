    ...
    <div class="row">
        <div class="col-lg-12" style="padding-left: 1px !important;">
            <div class="panel panel-default" style="margin-top: -25px !important;">
                <div class="panel-heading"><b> <i class="fa fa-bars" aria-hidden="true"></i> Preset Chores List</b></div>
                <!-- /.panel-heading -->
                        ...
                        <table class="table table-striped table-bordered table-hover responsive">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">@if($pageOrder == "ASC")
                                    <td class="text-center" width="5%" style="padding-top: 30px;">{{ ($datarecords->currentpage()-1) * $datarecords->perpage() + $i}}</td>@endif @if($pageOrder == "DESC")
                                    <td class="text-center" width="5%" style="padding-top: 30px;">{{ substr(($datarecords->currentpage()-1) * $datarecords->perpage() + $i - ($datarecords->total()+1),1)}}</td>@endif
                                    <td width="10%" class="text-center"><img src="{{ asset('public/images/chore-icon').'/'.$data->pre_icon }}" style="height: 50px;width: 50px;margin-bottom: 10px;margin-top: 10px;" /></td>
                                    <td style="padding-top: 30px;">{{ $data->pre_title }}</td>
                                    <td width="10%" class="text-center" style="padding-top: 30px;">{{ date('M-d-Y',strtotime($data->pre_createat)) }}</td>
                                    ...
                                    <td class="text-center" width="8%" style="padding-top: 30px;">
                                    ...
                                    <div class="modal fade" id="updaterecordModel<?php echo $i; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" style="width: 600px;">
                                            <div class="modal-content">
                                                ...
                                                <form class="form-horizontal" role="form" method="POST" action="{{ url('update-preset-chores') }}" style="margin-top: 10px;" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group{{ $errors->has('pre_title') ? ' has-error' : '' }}">
                                                               <label for="pre_title" class="col-md-3 control-label" style="text-align: right;">Preset Chores<font color="red">*</font></label>
                                                                <div class="col-md-8">
                                                                @if($data->pre_id == 1)
                                                                <input id="pre_title" type="text" class="form-control" name="pre_title" value="{{ $data->pre_title }}" placeholder="Preset Chores" rows="4" required maxlength="100" readonly>
                                                                @else
                                                                <input id="pre_title" type="text" class="form-control" name="pre_title" value="{{ $data->pre_title }}" placeholder="Preset Chores" rows="4" required maxlength="100">
                                                                @endif
                                                    ...
                                                    <div class="row" style="margin-bottom: 15px;">
                                                        <div class="col-lg-12">
                                                            <div class="form-group{{ $errors->has('pre_icon') ? ' has-error' : '' }}">
                                                               <label for="pre_icon" class="col-md-3 control-label" style="text-align: right;">Icon</label>
                                                                <div class="col-md-8">
                                                                <input id="pre_icon" type="file" class="form-control" name="pre_icon">
                                                                 @if($errors->has('pre_icon'))
                                                                <span class="help-block">
                                                                    <strong>{{ $errors->first('pre_icon') }}</strong>
                                                                </span>
                                                                @endif
                                                                </div>
                                                            </div>
...
<div class="modal fade" id="createNewModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="width: 600px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form class="form-horizontal" role="form" method="POST" action="{{ url('create-preset-chores') }}" style="margin-top: 10px;" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group{{ $errors->has('pre_title') ? ' has-error' : '' }}">
                           <label for="pre_title" class="col-md-3 control-label" style="text-align: right;">Preset Chores<font color="red">*</font></label>
                            <div class="col-md-8">
                            <input  id="pre_title" type="text" class="form-control" name="pre_title" placeholder="Preset Chores"  required maxlength="100">
                            @if ($errors->has('pre_title'))
                            <span class="help-block">
                                <strong>{{ $errors->first('pre_title') }}</strong>
                            </span> 
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group{{ $errors->has('pre_icon') ? ' has-error' : '' }}">
                           <label for="pre_icon" class="col-md-3 control-label" style="text-align: right;">Icon<font color="red">*</font></label>
                            <div class="col-md-8">
                            <input id="pre_icon" type="file" class="form-control" name="pre_icon" required>
                             @if($errors->has('pre_icon'))
                            <span class="help-block">
                                <strong>{{ $errors->first('pre_icon') }}</strong>
                            </span>
