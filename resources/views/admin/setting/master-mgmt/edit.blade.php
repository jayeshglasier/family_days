...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Edit Project Detail</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <b><i class="fa fa-cubes" aria-hidden="true"></i> Edit Project Detail</b>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('update-projects') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    <input type="hidden" name="Pro_Unique_Id" value="{{ $editdata->Pro_Unique_Id }}">
                    <div class="col-lg-6">
                        <div class="form-group{{ $errors->has('Pro_Name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="Pro_Name" name="Pro_Name" placeholder="Project Name" value="{{ $editdata->Pro_Name }}" required maxlength="100" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('Pro_Description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <textarea id="Pro_Description" type="text" class="form-control" name="Pro_Description" placeholder="Project Description" required>{{ $editdata->Pro_Description }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('Pro_Start_Date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <div class="input-group date">
                                    ...
                                    <input type="text" value="{{ $editdata->Pro_Start_Date }}" name="Pro_Start_Date" class="form-control pull-right" id="datepicker" required>
                                </div>
                        ...
                        <div class="form-group{{ $errors->has('Pro_End_Date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                 <div class="input-group date">
                                    ...
                                    <input type="text" value="{{ $editdata->Pro_End_Date }}" name="Pro_End_Date" class="form-control pull-right" id="datepickerone" required>
                                </div>
                        ...
                        <div class="form-group{{ $errors->has('Pro_Status') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" name="Pro_Status">
                                    <option value="0" {{ ($editdata->Pro_Status == '0') ? 'selected' : '' }}>Active</option>
                                    <option value="1" {{ ($editdata->Pro_Status == '1') ? 'selected' : '' }}>Inactive</option>
                                    <option value="2" {{ ($editdata->Pro_Status == '2') ? 'selected' : '' }}>Pending Work</option>
                                    <option value="3" {{ ($editdata->Pro_Status == '3') ? 'selected' : '' }}>Completed</option>
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('Pro_Status') ? ' has-error' : '' }}">
                            <label for="Pro_Status" class="col-md-4 control-label">Old Company Logo</label>
                            <div class="col-md-8">
                            <img src="{{ asset('public/images/projects/company-logo').'/'.$editdata->Pro_Com_Logo }}" style="height: 100px;" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group{{ $errors->has('Pro_Com_Name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="Pro_Com_Name" type="text" class="form-control" name="Pro_Com_Name" placeholder="Company Name" value="{{ $editdata->Pro_Com_Name }}" required maxlength="140"> @if ($errors->has('Pro_Com_Name'))
                                <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('Pro_Com_Address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <textarea id="Pro_Com_Address" type="text" class="form-control" name="Pro_Com_Address" placeholder="Company Address">{{ $editdata->Pro_Com_Address }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('Pro_Com_Email_Id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="Pro_Com_Email_Id" type="text" class="form-control phone" name="Pro_Com_Email_Id" placeholder="E-Mail ID" value="{{ $editdata->Pro_Com_Email_Id }}" required onblur="validateEmail(this);" maxlength="90">
                        ...
                        <div class="form-group{{ $errors->has('Pro_Com_Website') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="Pro_Com_Website" type="text" class="form-control" name="Pro_Com_Website" placeholder="Website" value="{{ $editdata->Pro_Com_Website }}" maxlength="240"> 
                        ...
                        <div class="form-group{{ $errors->has('Pro_Com_Mobile_No') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="Pro_Com_Mobile_No" type="text" class="form-control" name="Pro_Com_Mobile_No" placeholder="Contact Number" value="{{ $editdata->Pro_Com_Mobile_No }}" onkeyup="validatephone(this);" maxlength="10" required>
