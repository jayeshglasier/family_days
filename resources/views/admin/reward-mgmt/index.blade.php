    ...
    <div class="row">
        <div class="col-lg-12" style="padding-left: 1px !important;">
            <div class="panel panel-default" style="margin-top: -25px !important;">
                <div class="panel-heading"><b> <i class="fa fa-user" aria-hidden="true"></i> Reward List</b></div>
                <!-- /.panel-heading -->
                <div class="panel-body" style="overflow:auto;">
                    <a class="btn btn-primary" style="float: right;" href="{{ url('reward-details-export-excel',['type'=>'xls']) }}" onclick="return confirm('Are you sure? You want to download the reward record.')" data-toggle="tooltip" title="To download excel file!!">Export Excel</a>
                    <div class="dataTable_wrapper">
                        <form class="form-horizontal" role="form" method="get" action="{{ url('/reward-list') }}">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            <thead class="thead-table">
                                <tr>
                                    ...
                                    <th>Family Id</th>
                                    <th>Family Name</th>
                                    <th class="text-center">No of Reward</th>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td width="10%" class="text-center">
                                        @if($data->no_of_chore == 0) {{ '---'}} @else<a class="btn btn-primary" style="padding: 1px 6px;" href="{{ url('reward-list-export-excel',['id'=>$data->use_family_id,'type'=>'xls']) }}" onclick="return confirm('Are you sure? You want to download the reward record.')" data-toggle="tooltip" title="To download excel file!!"><i class="fa fa-file-excel-o" aria-hidden="true"></i> </a>@endif</td>
                                    <td class="text-center"  width="10%">
                                        <a href="{{ url('view-reward-list',$data->use_family_id) }}" data-toggle="tooltip" title="View Reward Details!">
