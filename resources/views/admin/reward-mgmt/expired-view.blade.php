            ...
            <div class="panel panel-default" style="">
                ...
                <div class="panel-body">
                    ...
                    <ul class="nav nav-pills">
                        <li class=""><a href="{{ url('view-reward-list',$familyId) }}"><i class="fa fa-database fa-fw"></i> Reward</a> </li>
                        <li class="active"><a href="{{ url('view-expired-reward-list',$familyId) }}"><i class="fa fa-database fa-fw"></i> Expired / Inactive Reward</a> </li>
                    </ul>
                    <!-- Tab panes -->
                          ...
                          @foreach($datarecords as $data)               
                           <div class="col-sm-6">
                                <div class="hero-widget well well-sm">
                                    ...
                                    <div class="text">
                                        <label class="text-muted"><b>@if($data->red_cat_name == "Other") {{ $data->red_rewards_name ? $data->red_rewards_name:'Other' }} @else {{ $data->red_cat_name }} @endif {{ '('.$data->red_brand_name.')' }}<small style="font-size: 12px;color: orange;"></small></b></label> <label style="float: right;color: orange">{{ $data->red_point }}<br>  
