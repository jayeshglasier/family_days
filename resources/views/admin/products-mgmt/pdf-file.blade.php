...
<body>
	<div class="page">
		<h3 style="text-align: center;"> <?php echo (isset($companyname) && $companyname != '' ? $companyname : 'ChoreUp - Preset Chores Record') ?></h3>
		<hr>
		<table style="width:100%;" border="0.4">
			<tbody>
				...
				<tr style="font-size: 14px;text-align:center;">
	                ...
	                <td>{{ date('M-d-Y',strtotime($data->pre_createat)) }}</td>
				</tr>@endforeach
			</tbody>
		</table>
	</div>
